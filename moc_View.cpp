...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (View::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&View::setSize)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void View::setSize(int _t1, int _t2)
{
