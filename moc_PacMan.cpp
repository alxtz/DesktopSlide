...
QT_MOC_LITERAL(3, 13, 11) // "destroySelf"

    },
    "PacMan\0move\0\0destroySelf"
};
...
void PacMan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PacMan *_t = static_cast<PacMan *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject PacMan::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PacMan.data,
      qt_meta_data_PacMan,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
